...
<body>
    <?php
        ...
        $about="Mahasiswa yang sedang mengadu nasib dan menuntut ilmu di UPN Veteran Jawa Timur, aku mempunyai hobby ber-olahraga dan main game, jika ada waktu luang sering kumanfaatkan untuk bermain game. Aku merupakan anak ke 2 dari 4 bersaudara, berikut data diriku ";
        $tanggal_lahir ="29-12-1999";
        $tempat_lahir="Mojokerto";
        $status="Mahasiswa";
        $sd="MI Muhammadiyah 5 Mojoagung";
        $smp="SMPN 3 Mojoagung";
        $sma="SMAN 1 Sooko Mojokerto";
